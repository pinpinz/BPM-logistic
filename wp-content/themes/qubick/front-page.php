...
<main class="mt-20 md:mt-10">
                ...
                <section class="bg-white ">
                    ...
                    <section class="bg-white ">
                    <div class="mt-0 flex h-screen bg-[url('<?php bloginfo('template_directory');?>/images/Home.jpg')] bg-fixed bg-cover bg-center"></div>
                    </section>
                    ...
                    <section class="bg-white dark:bg-white">
                        ...
                        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                            ...
                            <div class="lg:mr-auto place-self-center lg:col-span-8 lg:px-24 gs_revealY">
                                ...
                                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                                    <a href="#" class="inline-flex items-center justify-center w-full px-5 py-3 text-sm bg-[#fdce28] font-medium text-center text-gray-900 hover:text-white rounded-lg sm:w-auto hover:bg-[#004179] focus:ring-4 focus:ring-gray-100 dark:text-white dark:hover:bg-[#004179] dark:focus:ring-gray-800">
                                        More
                                    </a> 
