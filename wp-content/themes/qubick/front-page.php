                    ...
                    <section class="bg-white dark:bg-white">
                        ...
                        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                            <div class="hidden lg:mt-0 lg:col-span-4 lg:block pl-24 gs_revealX">
                                    ...
                                    <h1 class="max-w-2xl mb-4 text-2xl font-bold leading-none tracking-tight md:text-4xl xl:text-4xl text-yellow-300 ">MORE THAN <br> <font color="#004179"><span>25 YEARS OF</span></font> <br> EXPERIENCE <br></h1>  
                            ...
                            <div class="lg:mr-auto place-self-center lg:col-span-8 lg:px-24 gs_revealY">
                                ...
                                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                                    <a href="#" class="inline-flex items-center justify-center w-full px-5 py-3 text-sm bg-yellow-400 font-medium text-center text-gray-900 hover:text-white rounded-lg sm:w-auto hover:bg-sky-900 focus:ring-4 focus:ring-gray-100 dark:text-white dark:hover:bg-sky-900 dark:focus:ring-gray-800">
                                        More
                                    </a> 
