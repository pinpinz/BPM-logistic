...
<section class="bg-white dark:bg-gray-100">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img class="px-11" src="<?php bloginfo('template_directory');?>/images/AssetHome1.png" alt="HeroImage">
                <!-- <img src="./images/hero.png" alt="hero image"> -->
            </div>
            <div class="mr-auto place-self-center lg:col-span-7 px-24 ">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-gray-900">Connecting You, <br>Connecting Your Business</h1>
