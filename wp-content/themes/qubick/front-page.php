...
<section class="bg-white dark:bg-gray-100">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="hidden lg:mt-0 lg:col-span-4 lg:flex">
                <img class="pl-24" src="<?php bloginfo('template_directory');?>/images/AssetHome1.png" alt="HeroImage">              
            </div>
    ...
    <div class="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12 grid-cols-3">
        <div class=" place-self-center lg:col-span-4 ">
            <img class="h-32 lg:h-auto mb-3 lg:mb-0" src="<?php bloginfo('template_directory');?>/images/Asset 4.png" alt="HeroImage"> 
           ...
           <div class="flex place-self-center lg:col-span-4 lg:block">
            <img class="h-32 lg:h-auto mb-3 lg:mb-0" src="<?php bloginfo('template_directory');?>/images/Asset 5.png" alt="HeroImage"> 
            ...
            <div class="flex place-self-center lg:col-span-4 lg:block">
            <img class="h-32 lg:h-auto mb-3 lg:mb-0" src="<?php bloginfo('template_directory');?>/images/Asset 6.png" alt="HeroImage"> 
