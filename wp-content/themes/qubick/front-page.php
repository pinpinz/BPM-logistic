...
<main class="mt-10">
                ...
                <section class="bg-white ">
                    ...
                    <div class="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12 grid-cols-3 gs_revealY">
                        <div class=" place-self-center col-span-3 lg:col-span-4 hover:scale-125 hover:ease-in duration-1000">
                            <a href="service#service">
                                <img class=" lg:h-60 mb-3 lg:mb-0" src="<?php bloginfo('template_directory');?>/images/Asset 4.png" alt="HeroImage"> 
                            </a>
                        ...
                        <div class="place-self-center col-span-3 lg:col-span-4 hover:scale-125 hover:ease-in duration-1000">
                        <a href="service#service">
                            <img class=" lg:h-60 mb-3 lg:mb-0" src="<?php bloginfo('template_directory');?>/images/Asset 5.png" alt="HeroImage"> 
                        </a>
                        ...
                        <div class="place-self-center col-span-3 lg:col-span-4 hover:scale-125 hover:ease-in duration-1000">
                        <a href="service#service">
                        <img class=" lg:h-60 mb-3 lg:mb-0" src="<?php bloginfo('template_directory');?>/images/Asset 6.png" alt="HeroImage"> 
                        </a>
