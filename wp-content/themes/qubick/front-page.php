...
<main class="mt-20">
                <section class="bg-white dark:bg-gray-100 gs_revealX">
                    ...
                    <section class="bg-white dark:bg-gray-100 gs_revealY">
                    ...
                    <section class="bg-white dark:bg-gray-100">
                        ...
                        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                            <div class="hidden lg:mt-0 lg:col-span-4 lg:block pl-24 gs_revealX">
                                    ...
                                    <h1 class="max-w-2xl mb-4 text-2xl font-bold leading-none tracking-tight md:text-4xl xl:text-4xl text-yellow-300 ">MORE THAN <br> <span class="text-sky-900">25 YEARS OF</span> <br> EXPERIENCE <br></h1>  
