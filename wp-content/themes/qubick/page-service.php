...
<main class="mt-20">
                <section class="bg-white dark:bg-white">  
                    ...
                    <div class="hidden lg:flex grid w-11/12 md:w-5/6 xl:w-2/3 mx-auto gap-14 py-8 grid-cols-7 mb-10 h-72">
                        ...
                        <div class="l1 hover:pt-0 pt-5 px-3 place-self-center col-span-1 hover:bg-yellow-400 hover:w-2/3 duration-500">
                ...
                <section class="bg-yellow-400 dark:bg-yellow-400 ">    
                    ...
                    <div class="grid max-w-screen-xl px-8 mx-auto lg:gap-8 xl:gap-0 lg:pt-4 pt-10 lg:grid-cols-12 gs_revealX">
                    ...
                    <div class="grid max-w-screen-xl px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:pb-16 lg:pt-10 md:grid-cols-12 grid-cols-6 gs_revealX">
                ...
                <section class="bg-white dark:bg-white ">    
                    ...
                    <div class="grid max-w-screen-xl px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:pb-16 pt-10 md:grid-cols-12 grid-cols-6 gs_revealX">
