                    ...
                    <div class="hidden lg:flex grid max-w-screen-xl md:px-36 lg:px-42 mx-auto gap-14 py-8 grid-cols-7">
                        ...
                        <div class="pt-10 place-self-center col-span-1 hover:bg-yellow-400 hover:w-2/3">
                            <div class="rounded-full border-slate-100 bg-slate-100 place-self-center drop-shadow-2xl py-2 px-2">
                                <img class="w-auto place-self-center" src="<?php bloginfo('template_directory');?>/images/service/Asset 1.png" alt="HeroImage"> 
                            </div>
                            
                            <h2 class="hidden lg:block max-w-2xl mb-4 text-2xl font-normal leading-none tracking-tight md:text-2xl xl:text-2xl text-white font-sans text-center mt-10">Sea Freight</h2>
                        </div>
                         <div class="pt-10 place-self-center col-span-1 hover:bg-yellow-400 hover:w-2/3">
                            <div class="rounded-full border-slate-100 bg-slate-100 place-self-center drop-shadow-2xl py-2 px-2">
                                <img class="w-auto place-self-center" src="<?php bloginfo('template_directory');?>/images/service/Asset 3.png" alt="HeroImage"> 
                            </div>
                         ...
                         <div class="pt-10 place-self-center col-span-1 hover:bg-yellow-400 hover:w-2/3">
                            <div class="rounded-full border-slate-100 bg-slate-100 place-self-center drop-shadow-2xl py-2 px-2">
                                <img class="w-auto place-self-center" src="<?php bloginfo('template_directory');?>/images/service/Asset 4.png" alt="HeroImage"> 
                            </div>
                         ...
                         <div class="pt-10 place-self-center col-span-1 hover:bg-yellow-400 hover:w-2/3">
                            <div class="rounded-full border-slate-100 bg-slate-100 place-self-center drop-shadow-2xl py-2 px-2">
                                <img class="w-auto place-self-center" src="<?php bloginfo('template_directory');?>/images/service/Asset 5.png" alt="HeroImage"> 
                            </div>
                        ...
                        <div class="pt-10 place-self-center col-span-1 hover:bg-yellow-400 hover:w-2/3">
                            <div class="rounded-full border-slate-100 bg-slate-100 place-self-center drop-shadow-2xl py-2 px-2">
                                <img class="w-auto place-self-center" src="<?php bloginfo('template_directory');?>/images/service/Asset 6.png" alt="HeroImage"> 
                            </div>
                         ...
                         <div class="pt-10 place-self-center col-span-1 hover:bg-yellow-400 hover:w-2/3">
                            <div class="rounded-full border-slate-100 bg-slate-100 place-self-center drop-shadow-2xl py-2 px-2">
                                <img class="w-auto place-self-center" src="<?php bloginfo('template_directory');?>/images/service/Asset 7.png" alt="HeroImage"> 
                            </div>
                         ...
                         <div class="pt-10 place-self-center col-span-1 hover:bg-yellow-400 hover:w-2/3">
                            <div class="rounded-full border-slate-100 bg-slate-100 place-self-center drop-shadow-2xl py-2 px-2">
                                <img class="w-auto place-self-center" src="<?php bloginfo('template_directory');?>/images/service/Asset 8.png" alt="HeroImage"> 
                            </div>
                    ...
                    <section class="bg-white dark:bg-gray-100">
                        ...
                        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                            <div class="hidden lg:mt-0 lg:col-span-4 lg:block pl-24">
                                    ...
                                    <h1 class="max-w-2xl mb-4 text-2xl font-bold leading-none tracking-tight md:text-4xl xl:text-4xl text-yellow-300 font-sans">MORE THAN <br> <span class="text-sky-900">25 YEARS OF</span> <br> EXPERIENCE <br></h1>  
